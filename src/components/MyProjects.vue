  ...
  <div class="mt-12 mb-10 text-gray-900">
    ...
    <div class="relative group pb-2/3">
      ...
      <a href="https://dominoxb.github.io/donutshop/" target="_blank">
        <div
          class="p-2 w-full opacity-90 transition duration-700 absolute bottom-0 text-center bg-sky-100 bg-opacity-80 lg:opacity-0 lg:group-hover:opacity-100 lg:bg-opacity-50 xl:p-8">
